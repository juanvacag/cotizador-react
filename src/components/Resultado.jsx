...
const Resultado = () => {
    ...
    return (
        <div className="bg-gray-100 text-center mt-5 p-5 shadow">
            ...
            <p className="my-2"><span className="font-bold">Origen: </span>{nombreMarca.nombre}</p>
            <p className="my-2"><span className="font-bold">Matriculación: </span>{yearRef.current}</p>
            <p className="my-2"><span className="font-bold">Plan: </span>{nombrePlan.nombre}</p>
            <p className="my-2 text-2xl"><span className="font-bold">Total Seguro: </span>{resultado}</p>
        </div>
    )
}
